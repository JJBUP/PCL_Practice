...
int main(int argc, char **argv)
{
    ...
    pcl::io::loadPCDFile("./table_scene_lms400.pcd", pointCloud);
    ...
    */
    ...
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "orginal image");
